...
class ManageAccount:
    def __init__(self, config=None, redis_conn=None, db_conn=None):
...
class SyncAccountBotsInRedis:
    ...
    def set_account_bots_in_redis(self, account_id):
        set_account_bots_in_redis(self.message.config, self.message.redis_conn, account_id, self.message.bots)
